...
### 2025-11-16 测试了几个策略，于11月14号改回使用1天K线，权重使用趋势跟踪型，信号阈值为0.55.到16号截止基本回归到正常波动。使用分钟K线和小时K线时发出的策略信号更容易变动，导致交易方向频繁变化。最新运行状态：
...
<img width="1636" height="1012" alt="QQ_1763429822693" src="https://github.com/user-attachments/assets/7783e428-a1a6-48e1-a85c-c7b8756919a5" />
