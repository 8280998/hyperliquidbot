...
预设模式	        权重值	         策略特点	   适用市场	    风险等级

趋势跟踪型 	2.0,1.0,1.5,1.0	侧重均线和MACD	趋势明显市场	   中

震荡市型  	0.8,2.0,0.8,1.5	侧重RSI和布林	   震荡横盘市场	  中低

平衡稳健型   	1.5,1.2,1.0,0.8	均衡配置	      通用型       	中

激进交易型	   1.0,1.8,1.5,0.5	侧重RSI和MACD	高波动市场	      高

保守稳健型	   2.0,1.0,0.5,1.5	侧重均线和布林	稳健投资	      低

自定义	       用户自定义	      灵活配置	       专业用户	     可变
